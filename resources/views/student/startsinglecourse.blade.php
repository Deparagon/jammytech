...
@section('pagetitle')
  Start {{ $course->name }} Lesson | Tutorago
@endsection
...
<h2 class="top-start-based"> <span> Start {{ $course->name }} </span> </h2>
...
<div class="col-sm-12">
 ...
 <div class="panel panel-default">
     <div class="panel-heading">  
          <h4 class="panel-title"> Selected Lessons </h4>
     </div>
     <div class="panel-body">
...
@if (isset($course))
<tr> <td> <img class="list-img" src="/uploads/{{ $course->imageurl }}"> </td> <td> {{ $course->name }}</td> <td> {{ $course->description }} </td> <td> {{ $coursedata->name}}</td> <td> <input checked class="form-control" type="radio" name="lessontostart" value="{{ $course->id }}"></td> </tr>
