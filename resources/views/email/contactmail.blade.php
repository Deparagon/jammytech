...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
<tr>
<td align="center" width="59" height="59" class="icon-border" style="border: 2px solid #fff;"><a  href="#" style="color: #3291db;text-decoration: none;outline: none;"><img  src="{{ url('/') }}/images/email/icon-35-11.png" width="35" height="35" alt="icon" class="icon35"   style="border: 0;display: block;-ms-interpolation-mode: bicubic;width: 35px;height: auto;max-width: 35px;max-height: 35px;"></a>
</td>
</tr>
</table>
</td>
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
<tr>
<td align="center" width="59" height="59" class="icon-border" style="border: 2px solid #fff;"><a  href="#" style="color: #3291db;text-decoration: none;outline: none;"><img  src="{{ url('/') }}/images/email/icon-35-12.png" width="35" height="35" alt="icon" class="icon35"   style="border: 0;display: block;-ms-interpolation-mode: bicubic;width: 35px;height: auto;max-width: 35px;max-height: 35px;"></a>
</td>
</tr>
</table>
</td>
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
<tr>
<td align="center" width="59" height="59" class="icon-border" style="border: 2px solid #fff;"><a  href="#" style="color: #3291db;text-decoration: none;outline: none;"><img  src="{{ url('/') }}/images/email/icon-35-13.png" width="35" height="35" alt="icon" class="icon35"   style="border: 0;display: block;-ms-interpolation-mode: bicubic;width: 35px;height: auto;max-width: 35px;max-height: 35px;"></a>
</td>
</tr>
</table>
</td>
